...
var _ = Describe("PostGresConnection Controller", func() {
	Context("When reconciling a resource", func() {
		...
		postgresconnection := &postgresv1.PostGresConnection{}

		BeforeEach(func() {
			By("creating the custom resource for the Kind PostGresConnection")
			err := k8sClient.Get(ctx, typeNamespacedName, postgresconnection)
		...
		AfterEach(func() {
			...
			By("Cleanup the specific resource instance PostGresConnection")
